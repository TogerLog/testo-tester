extends TaskDataUI
class_name SpotTaskDataConfiguredUI

@export var choose_image: ImageExplorer
@export var spots: UIArraySpotsConfigured
...
func configure_spot(spot_index: int):
	var configurator: SpotConfiguratorConfigured = configurator_prefab.instantiate()
